...
route::get('portfolio/category/{id}', [HomeController::class, 'category'])->name('category.view');
...
route::get('/contact', [HomeController::class, 'contact'])->name('contact.view');
route::get('/project', [HomeController::class, 'project'])->name('project.view');
route::get('projects/category/{id}', [HomeController::class, 'projects'])->name('projects.details');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('projectds')->group(function () {
        route::get('/view', [ProjectsController::class, 'index'])->name('projectds.view');
        route::get('/add', [ProjectsController::class, 'show'])->name('projectds.show');
        route::post('/store', [ProjectsController::class, 'store'])->name('projectds.store');
        route::get('/edit/{id}', [ProjectsController::class, 'edit'])->name('projectds.edit');
        route::post('/update/{id}', [ProjectsController::class, 'update'])->name('projectds.update');
        route::get('/delete/{id}', [ProjectsController::class, 'delete'])->name('projectds.delete');
    });
});
